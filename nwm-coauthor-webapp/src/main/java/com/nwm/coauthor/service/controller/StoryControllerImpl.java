...
public class StoryControllerImpl extends BaseControllerImpl implements StoryController {
    ...
    public ResponseEntity<CreateStoryResponse> createStory(@RequestHeader("Authorization") String coToken, @RequestBody CreateStoryRequest createStoryRequest) throws SomethingWentWrongException,
    ...
    public ResponseEntity<AddEntryResponse> addEntry(@RequestHeader("Authorization") String coToken, @RequestBody AddEntryRequest entry) throws SomethingWentWrongException,
