...
//        NewStoryRequest createStoryRequest = CreateStoryBuilder.createValidStory(users, 0, null);
//
//        ResponseEntity<NewStoryResponse> createdStory = storyClient.createStory(users.get(0).getCoToken(), createStoryRequest);
//
...
//
//        NewStoryRequest createStoryRequest = CreateStoryBuilder.createValidStory(users, 0, fbFriends);
//        ResponseEntity<NewStoryResponse> createdStory = storyClient.createStory(users.get(0).getCoToken(), createStoryRequest);
//        String storyId = createdStory.getBody().getStoryId();
//
